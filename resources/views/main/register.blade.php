...
<body class="register-body">
    <form action="" class="login">
        ...
        <div class="inputs hidden second">
            ...
            <label for="initiation-year">Initiation Year</label>
            <input type="year" id="initiation-year">
            <label for="batch-name">Batch Name</label>
            <input type="text" id="batch-name">
            <label for="baptismal-name">Baptismal Name</label>
            <input type="text" id="baptismal-name">
        ...
        <div class="inputs hidden third">
            ...
            <label for="ritualization-status">Ritualization Status</label>
            <input type="text" id="ritualization-status">
            <label for="ritualization-year">Ritualization Year</label>
            <input type="year" id="ritualization-year">
            <label for="position-held">Position Held</label>
            <input type="text" id="position-held">
            <label for="position-year">Year</label>
            <input type="year" id="position-year">
        ...
        <div class="inputs hidden fourth">
            ...
            <label for="alumni-assoc">Alumni Association</label>
            <input type="text" id="alumi-assoc">
            <label for="assoc-position">Position Held</label>
            <input type="text" id="assoc-position">
            <label for="assoc-position-year">Year</label>
            <input type="year" id="assoc-position-year">
